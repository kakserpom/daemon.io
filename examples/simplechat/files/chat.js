...
{
 "serverUrl": {
                ws: 'wss://'+document.domain+':8048/Chat',
 ...
 "updatedUserlist": function()
 {
  ...
  if (!found)
  {
   if ($.chat.tags.toString() != '') {$('#userlist').html('<div class="no_tagget">No users tagged \'' + htmlspecialchars($.chat.tags.toString()) + '\'</div>');}
...
if (typeof WebSocket != 'undefined') {WebSocket.__swfLocation = "/examples/simplechat/files/websocket/WebSocketMain.swf";}
