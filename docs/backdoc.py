...
if __name__ == '__main__':
    template_html = open(os.path.dirname(os.path.realpath(__file__)) + '/template.html', 'r').read()

    BackDoc(
        markdown_converter=Markdown(extras=['toc','wiki-tables','code-friendly','fenced-code-blocks']), 
