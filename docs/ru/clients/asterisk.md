...
##### methods # Методы
 ...
 ```
   ...
   -.n.ti `:hc`$cb` &mdash; `:phc`callback ( [Connection](#../../connection) $conn, array $packet )` &mdash; вызывается когда будет установлена связь с сервером
...
##### methods # Методы
 ...
 ```
   ...
   -.n.ti `:hc`$cb` &mdash; `:phc`callback ( [Connection](#../) $conn, array $packet )` &mdash; вызывается когда будет получен результат
 ...
 ```
   ...
   -.n `:hc`$cb` &mdash; `:phc`callback ( [Connection](#../) $conn, array $packet )` &mdash; вызывается когда будет получен результат
